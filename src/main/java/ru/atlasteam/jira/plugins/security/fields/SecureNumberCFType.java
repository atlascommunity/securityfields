...
public class SecureNumberCFType extends NumberCFType {
    private final SecuritySchemeService securitySchemeService;

    protected SecureNumberCFType(CustomFieldValuePersister customFieldValuePersister, DoubleConverter doubleConverter, GenericConfigManager genericConfigManager, SecuritySchemeService securitySchemeService) {
    ...
    public Map<String, Object> getVelocityParameters(Issue issue, CustomField field, FieldLayoutItem fieldLayoutItem) {
        ...
        if (securitySchemeService.isAccessibleForLoggedInUser(field, issue))
            result.put("viewTemplate", "templates/plugins/fields/edit/edit-number.vm");
        return result;
    }
